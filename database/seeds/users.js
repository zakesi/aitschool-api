exports.seed = function(knex) {
  return Promise.all([
    knex("users").insert([
      {
        ...
        country: "中国",
        avatar_url:
          "http://thirdwx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJ7g7P1d5ddBiaE8UicvAk87yBKq4icFa4BP6eicHZkymPMR0bicibWuTQ55ChCvWqkQBr6zg4ibpmESljdg/132"
      }
    ]),

    knex("roles").insert([{ id: 1, name: "管理员" }]),
    ...
    knex("user_roles").insert([{ role_id: 1, user_id: 1 }])
  ]);
};
